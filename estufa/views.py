...
from rest_framework.decorators import action #action: ações personalizadas para criar rota em ViewSets
from rest_framework.response import Response #Response: retormar respostas HTTP formatadas
...
class LeituraViewSet(viewsets.ModelViewSet):
    ...
    def ultimas_24h(self,request):
        """Retorna leituras de últimas 24 horas"""
